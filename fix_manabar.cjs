...
// The messed up area starts at "        {/* Health Bar */}"
// and ends at "        {/* Chat System */}"
const badAreaRegex = /        \{\/\* Health Bar \*\/\}[\s\S]*?        \{\/\* Chat System \*\/\}/;

const fixedArea = `        {/* Health Bar */}
...
code = code.replace(badAreaRegex, fixedArea);

fs.writeFileSync('src/App.tsx', code);
console.log('Fixed mana bar rendering in App.tsx');
