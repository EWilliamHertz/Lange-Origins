...
const regex = /        <div className="absolute bottom-6 left-1\/2 transform -translate-x-1\/2 flex gap-1 p-2 bg-black\/40 backdrop-blur-md rounded-xl border border-white\/10 shadow-2xl">\n\}\n\n          \{\/\* Right Action Bar Slideout \*\/\}[\s\S]*?          \}\)\n          \}/;

const fixedHotbar = `        <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex gap-1 p-2 bg-black/40 backdrop-blur-md rounded-xl border border-white/10 shadow-2xl">
