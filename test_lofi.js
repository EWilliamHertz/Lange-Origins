...
// We will add master volume and lofi hiphop generator
const replacement = `// Simple Web Audio API Synthesizer for game sounds
...
fs.writeFileSync('src/lib/audio.ts', replacement);
