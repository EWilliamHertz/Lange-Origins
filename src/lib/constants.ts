...
export const BlockColors: Record<BlockType, string> = {
  ...
  [BlockType.GrandExchange]: '#FFB300',
  [BlockType.BossGolem]: '#1A237E',
  [BlockType.Slime]: '#00E676',
  [BlockType.Orc]: '#33691E',
  [BlockType.Demon]: '#B71C1C',
...
export const SolidBlocks = new Set([
  ...
  BlockType.Farmland, BlockType.Chest, BlockType.GrandExchange
]);
...
export const BlockHardness: Record<BlockType, number> = {
  ...
  [BlockType.GrandExchange]: Infinity,
...
export const BlockNames: Record<BlockType, string> = {
  ...
  [BlockType.GrandExchange]: 'Grand Exchange',
  [BlockType.BossGolem]: 'Giant Golem',
  [BlockType.Slime]: 'Slime',
  [BlockType.Orc]: 'Orc',
  [BlockType.Demon]: 'Demon',
